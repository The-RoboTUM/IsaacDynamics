...
gym.register(
    ...
    kwargs={
        ...
        "skrl_pid_cfg_entry_point": f"{agents.__name__}:skrl_pid_cfg.yaml",
        "skrl_random_cfg_entry_point": f"{agents.__name__}:skrl_random_cfg.yaml",
        "skrl_unactuated_cfg_entry_point": f"{agents.__name__}:skrl_unactuated_cfg.yaml",
    },
)
